  ...
  return (
    <section className="py-24 bg-gradient-to-br from-purple-900 via-pink-900 to-purple-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-10 left-10 w-40 h-40 bg-gold-400/10 rounded-full blur-3xl floating-animation"></div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20 fade-in-up">
          <div className="inline-flex items-center space-x-2 bg-yellow-500/10 backdrop-blur-sm rounded-full px-6 py-3 border border-yellow-500/20 mb-8">
            ...
            <span className="text-yellow-300 font-medium">Exclusive Opportunity</span>
          </div>
          
          <h2 className="text-5xl md:text-7xl font-black text-white mb-8 text-shadow">
            Founder NFT
            <span className="block gradient-text">Pre-Sale</span>
          </h2>
          ...
          <div className="bg-gradient-to-r from-yellow-400 to-orange-500 rounded-2xl p-8 inline-block shadow-2xl mb-12">
            <div className="flex items-center justify-center space-x-4 mb-4">
              ...
              <div className="text-white">
                ...
                <div className="text-lg">Target Raise</div>
              </div>
              <div className="text-6xl">💎</div>
              <div className="text-white">
                <div className="text-4xl font-black">5,000</div>
                <div className="text-lg">Founder NFTs</div>
              </div>
              <Zap className="h-12 w-12 text-white" />
              <div className="text-white">
                <div className="text-4xl font-black">$1,000</div>
                <div className="text-lg">Each</div>
              </div>
            </div>
          </div>
        </div>
